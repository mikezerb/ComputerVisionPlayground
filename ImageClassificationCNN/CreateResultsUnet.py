...
filename = "./ComparativeResults.xlsx"
Model2LoadFullName = ['./plantCNN.h5']
Where2Look4Images = './Plant segmentation/input'
Where2Look4Masks = './Plant segmentation/output'
Where2SaveTheResults = './Plant_CNN_results/'
